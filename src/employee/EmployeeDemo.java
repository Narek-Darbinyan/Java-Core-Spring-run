...
public class EmployeeDemo {
    ...
    private static void addEmployee() {
        System.out.println("pleas input name,surname,employeeId,salary,company,position,dateOfBirthday(29/02/1992)");
        ...
        if (employee == null) {
          ...
          //  Employee newEmployee = new Employee(employeeData[0], employeeData[1],
               //     employeeId, Double.parseDouble(employeeData[3]), employeeData[4], employeeData[5], registerDate[6];
